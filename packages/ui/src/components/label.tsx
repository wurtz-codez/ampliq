import { cn } from "@ampliq/ui/lib/utils";
import type * as React from "react";

function Label({ className, ...props }: React.ComponentProps<"label">) {
	return (
		<>
			{/* biome-ignore lint/a11y/noLabelWithoutControl: This is a generic label component that receives its association via props */}
			<label
				className={cn(
